...
NOMES = ["Dejair", "Robervalsom", "Carandiru", "Francesco", "Virguline",
         "Galatas", "Dorivaldo", "CPX", "Lula", "Bozonaru", "Garry"
         ]
        ...
        if random.random() <= 0.3:
            ...
            if escolha == "s":
                if random.random() >= 0.5:
                    ...
                    print("{} fugiu!!! _|_ !!!".format(pokemon))
            else:
                print("Ok, boa viagem")
        else:
            print("Essa exploração falhou")
